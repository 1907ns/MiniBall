 ...
 */
public class StickUn extends Sprite {
     ...
     */
    public StickUn(MiniBall game, OrthographicCamera camera, FitViewport fitViewport, Terrain terrain){
        this.game = game;
        this.camera = camera;
    ...
    public void setPosIni(){
        this.setX(0-terrain.getWidth()/2f - diametre);
