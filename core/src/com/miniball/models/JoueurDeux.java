...
/**
 * Classe du joueur 2 qui hérite de la classe Sprite
 */
public class JoueurDeux extends Sprite {
     ...
     */
    public JoueurDeux(MiniBall game, OrthographicCamera camera, FitViewport fitViewport, Terrain terrain,GameWorld gameWorld){
        this.game = game;
        this.camera = camera;
        this.fitViewport=fitViewport;
        this.terrain=terrain;
        Texture texture = new Texture("images/JoueurGauche.png");
    ...
    public void setPosIni(){
        body.setTransform(0-fitViewport.getWorldWidth()/4f,0,body.getAngle());
    ...
    public void concedePos(){
        body.setTransform(0-terrain.getWidth()/8,0,body.getAngle());
        body.setLinearVelocity(0,0);
        this.setPosition(body.getPosition().x-this.getWidth()/2f,body.getPosition().y-this.getHeight()/2f);
        this.setRotation(body.getAngle() * MathUtils.radiansToDegrees);
    }
    ...
    public  void setBody(){
        ...
        bodyDef.position.set(0-fitViewport.getWorldWidth()/4f, 0);
    ...
    /**
     * Fonction qui permet du réajuster la position du joueur par rappor à son body
     */
     public void setPosToBody(){
         this.setX(body.getPosition().x-this.getWidth()/2f);
         this.setY(body.getPosition().y-this.getHeight()/2f);
         this.setRotation(body.getAngle() * MathUtils.radiansToDegrees);
     }
